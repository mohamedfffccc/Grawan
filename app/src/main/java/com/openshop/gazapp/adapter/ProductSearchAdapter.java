...
import com.openshop.gazapp.view.activity.home.SaarchActivity;
...
public class ProductSearchAdapter extends RecyclerView.Adapter<ProductSearchAdapter.ProductViewHolder> {
    ...
    SaarchActivity activity;
    private int i;
    private OrderItem item;


    public ProductSearchAdapter(List<ProductData> articleslist, Context context, SaarchActivity activity) {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.productTvPrice.setText(articleslist.get(position).getPrice() + " ريال ");
